...
| --- | --- | --- |
| query-string | https://github.com/sindresorhus/query-string | [MIT](evidence/licenses/query-string-MIT.txt) |
| p-map | https://github.com/sindresorhus/p-map | [MIT](evidence/licenses/p-map-MIT.txt) |
| validator.js | https://github.com/validatorjs/validator.js | [MIT](evidence/licenses/validator-js-MIT.txt) |
